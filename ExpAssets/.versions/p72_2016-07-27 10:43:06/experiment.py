...
class articulation_circle(klibs.Experiment):
	...
	def setup(self):
		...
		#	self.articulation_line = kld.Line(25, DARKGREY, default_stroke, i) # For whatever reason this doesn't work, maybe bug.
			
		self.articulation_line = kld.Line(25, DARKGREY, default_stroke)
