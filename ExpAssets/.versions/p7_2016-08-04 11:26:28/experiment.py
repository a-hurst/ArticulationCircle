...
class articulation_circle(klibs.Experiment, klibs.BoundaryInspector):
	...
	def setup(self):
		...
		self.articulation = kld.Ellipse(70, fill=GREY)
		self.target = kld.Asterisk(10, color=TOMATO_RED, stroke=default_stroke) # Placeholder for now
		
		#self.line_0 = self.line(90, articulation_length, [BLACK, default_stroke])
		#self.line_45 = self.line(45, articulation_length, [BLACK, default_stroke])
		#self.line_90 = self.line(0, articulation_length, [BLACK, default_stroke])
		#self.line_135 = self.line(-45, articulation_length, [BLACK, default_stroke])
