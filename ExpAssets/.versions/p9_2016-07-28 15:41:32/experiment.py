...
class articulation_circle(klibs.Experiment):
	...
	def setup_response_collector(self):
		...
		self.rc.color_listener.add_boundary("color ring", [Params.screen_c, self.response_circle.radius - 132, self.response_circle.radius - 100], "anulus")
		self.rc.color_listener.set_target(self.fixation, Params.screen_c, 5)
