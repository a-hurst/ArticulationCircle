...
class articulation_circle(klibs.Experiment, klibs.BoundaryInspector):
	...
	def setup(self):
		...
		self.circle = kld.Annulus(circle_width + 24, 24, fill=WHITE)
		self.circle_outline = kld.Annulus(circle_width + 28, 28, fill=DARKGREY)
		...
		self.line_0 = self.line(90, articulation_length, [(64,64,64), default_stroke])
		self.line_45 = self.line(45, articulation_length, [(64,64,64), default_stroke])
		self.line_90 = self.line(0, articulation_length, [(64,64,64), default_stroke])
		self.line_135 = self.line(-45, articulation_length, [(64,64,64), default_stroke])
	...
	def trial_prep(self):
		...
		events.append([events[-1][0] + 300, 'target_off'])
