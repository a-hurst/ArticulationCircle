...
class articulation_circle(klibs.Experiment, klibs.BoundaryInspector):
	...
	def setup(self):
		...
		self.line_0 = self.line(0, 25, [BLACK, default_stroke])
		self.line_45 = self.line(45, 25, [BLACK, default_stroke])
		self.line_90 = self.line(90, 25, [BLACK, default_stroke])
		self.line_135 = self.line(-45, 25, [BLACK, default_stroke])
	...
	def trial(self):
		...
		#self.fill(WHITE)
		#self.blit(self.linetest, 5, Params.screen_c)
		#self.flip()
		#self.any_key()
	...
	def click_to_continue(self):
		self.fill(WHITE)
		self.blit(self.line_0, 5, (Params.screen_x // 5, Params.screen_y // 2))
		self.blit(self.line_45, 5, (2*Params.screen_x // 5, Params.screen_y // 2))
		self.blit(self.line_90, 5, (3*Params.screen_x // 5, Params.screen_y // 2))
		self.blit(self.line_135, 5, (4*Params.screen_x // 5, Params.screen_y // 2))
		self.flip()
	...
	def line(self, rotation, canvas_width, stroke):
		...
		if rotation == 45:
			start = util.point_pos(canvas_center, canvas_width // 2, 225)
			end = util.point_pos(canvas_center, canvas_width // 2, 45)
		if rotation == -45:
			start = util.point_pos(canvas_center, canvas_width // 2, 45)
			end = util.point_pos(canvas_center, canvas_width // 2, 225)
		if rotation == 0:
