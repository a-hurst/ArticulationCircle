...
class articulation_circle(klibs.Experiment, klibs.BoundaryInspector):
	...
	def setup(self):
		...
		self.linetest = self.line(90, 25, [BLACK, default_stroke])
	...
	def line(self, rotation, canvas_width, stroke):
		...
		line_symbol = surf.symbol((0, 0), sym, aggdraw.Pen(*stroke))
		line_numpy = npsurf.aggdraw_to_numpy_surface(line_symbol)
		return line_numpy
