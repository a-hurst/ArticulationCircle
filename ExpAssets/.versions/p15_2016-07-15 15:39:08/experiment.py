...
class articulation_circle(klibs.Experiment):
	...
	def setup(self):
		...
		self.articulation = kld.Line(25, color=DARKGREY, thickness=default_stroke) # For whatever reason this doesn't work, maybe bug.
	...
	def trial(self):
		...
		#self.blit(self.circle, 5, Params.screen_c)
		#for angle in articulations:
		#	self.blit(self.articulation, 5, util.point_pos(Params.screen_c, (circle_width / 2), angle))			
		#self.flip(1.000)
		#
		#self.blit(self.fixation, 5, Params.screen_c)
		#self.blit(self.circle, 5, Params.screen_c)
