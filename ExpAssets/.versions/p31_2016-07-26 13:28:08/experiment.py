...
class articulation_circle(klibs.Experiment):
	...
	def setup(self):
		...
		self.response_circle.radius = (circle_width + 15) // 2
	...
	def setup_response_collector(self):
		...
		self.rc.color_listener.add_boundary("response circle", Params.screen_c, [self.response_circle.radius - 30, self.response_circle.radius], ANULUS_BOUNDARY)
