...
class articulation_circle(klibs.Experiment, klibs.BoundaryInspector):
	...
	def setup(self):
		...
		self.line_0 = self.line(90, articulation_length, [articulation_colour, default_stroke])
		self.line_45 = self.line(45, articulation_length, [articulation_colour, default_stroke])
		self.line_90 = self.line(0, articulation_length, [articulation_colour, default_stroke])
		self.line_135 = self.line(-45, articulation_length, [articulation_colour, default_stroke])
	...
	def line(self, rotation, canvas_width, stroke):
		...
		surf.symbol((0, 0), sym, aggdraw.Pen((255,99,71), 5, 255))
