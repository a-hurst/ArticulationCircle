...
class articulation_circle(klibs.Experiment, klibs.BoundaryInspector):
	...
	def setup(self):
		...
		self.line_0 = kld.NewNewLine(25, BLACK, default_stroke, 90)
		self.line_45 = kld.NewNewLine(25, BLACK, default_stroke, 45)
		self.line_90 = kld.NewNewLine(25, BLACK, default_stroke, 0)
		self.line_135 = kld.NewNewLine(25, BLACK, default_stroke, 135)
