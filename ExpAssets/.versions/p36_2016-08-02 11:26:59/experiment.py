...
class articulation_circle(klibs.Experiment):
	...
	def trial_prep(self):
		...
		events.append([events[-1][0] + 100, 'target_off'])
	...
	def trial(self):
		...
		response_loc = self.rc.color_listener.response(True, False)
		self.response_angle = 360 - response_loc if response_loc > 180 else response_loc
		...
		return {
			...
			"deg_err": self.angle - self.response_angle
		}
