...
class articulation_circle(klibs.Experiment, klibs.BoundaryInspector):
	...
	def setup(self):
		...
		self.circle = kld.Annulus(circle_width + 32, 32, stroke=[default_stroke, DARKGREY, 3], fill=WHITE)
		...
		#self.line_0 = self.line(90, 25, [BLACK, default_stroke])
		#self.line_45 = self.line(45, 25, [BLACK, default_stroke])
		#self.line_90 = self.line(0, 25, [BLACK, default_stroke])
		#self.line_135 = self.line(-45, 25, [BLACK, default_stroke])
		
		self.line_0 = kld.NewNewLine(25, DARKGREY, default_stroke, 90)
		self.line_45 = kld.NewNewLine(25, DARKGREY, default_stroke, 45)
		self.line_90 = kld.NewNewLine(25, DARKGREY, default_stroke, 0)
		self.line_135 = kld.NewNewLine(25, DARKGREY, default_stroke, 135)
		
		#self.testnewnewline = kld.NewNewLine(25, BLACK, default_stroke, 90)
