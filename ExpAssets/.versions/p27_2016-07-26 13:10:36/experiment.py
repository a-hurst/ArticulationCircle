...
class articulation_circle(klibs.Experiment):
	...
	def setup(self):
		...
		self.response_circle.radius = self.response_circle.diameter // 2
	...
	def setup_response_collector(self):
		...
		self.rc.color_listener.add_boundary("color ring", [Params.screen_c, self.response_circle.radius - 30, self.response_circle.radius], "anulus")
