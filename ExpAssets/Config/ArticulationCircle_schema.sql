...
your changes just delete your database files, or just run:
  ...
  rm /Users/ray/Documents/Klibs Playground/articulation_circle/ExpAssets/articulation_circle.db*
...
destroyed and rebuilt. If you wish to keep the data you currently have, be sure to first run:
  ...
  klibs export /Users/ray/Documents/Klibs Playground/articulation_circle

This wil export the database in it's current state to text files found in /Users/ray/Documents/Klibs Playground/Data.
...
CREATE TABLE trials (
	...
	trial_articulations text not null,
	response_articulations text not null,
	target_brightness text not null,
